...
zipInput.addEventListener("oninput", function(){
...
function orderComplete(){
  ...
  document.querySelector(".container > section:nth-child(3) fieldset > div:nth-child(7) input").style.display = "none";
  ...
  document.querySelector(".container > section:nth-child(3) fieldset ul:nth-child(6) div").style.display = "block";
